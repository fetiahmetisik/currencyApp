...
function Currency() {
  ...
  return (
    <div>
      <div className="currency-main" style={{ backgroundImage: "none", backgroundColor: "#f0f0f0" }}>
        <div
          style={{
        ...
        <div style={{ marginTop: "20px" }}>
          <input
            ...
            onKeyDown={(e) => e.key === "Enter" && exchange()} // Enter tuşuna basıldığında exchange fonksiyonunu çağırır
